...
export declare class MglTimelineEntryContentComponent implements AfterViewInit {
    ...
    animate(): void;
    setStyle(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MglTimelineEntryContentComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MglTimelineEntryContentComponent, "mgl-timeline-entry-content", never, {}, {}, never>;
}
