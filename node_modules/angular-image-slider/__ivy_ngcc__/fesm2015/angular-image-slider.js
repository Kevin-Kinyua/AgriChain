...
function SliderComponent_img_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@move.done", function SliderComponent_img_4_Template_img_animation_move_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r66); const ctx_r65 = ɵngcc0.ɵɵnextContext(); return ctx_r65.onFinish($event); })("@move.start", function SliderComponent_img_4_Template_img_animation_move_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r66); const ctx_r67 = ɵngcc0.ɵɵnextContext(); return ctx_r67.onStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const url_r63 = ctx.$implicit;
    const i_r64 = ctx.index;
    const ctx_r62 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("@move", ctx_r62.state)("src", url_r63, ɵngcc0.ɵɵsanitizeUrl);
    ɵngcc0.ɵɵattribute("class", i_r64);
} }
...
SliderComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: SliderComponent, selectors: [["angular-image-slider"]], inputs: { autoRotate: "autoRotate", autoRotateAfter: "autoRotateAfter", autoRotateRight: "autoRotateRight", images: "images" }, decls: 10, vars: 1, consts: [["id", "container"], [1, "overlay-left"], [1, "overlay-right"], ["id", "grid", 1, "image-cropper"], ["alt", "", 3, "src", 4, "ngFor", "ngForOf"], ["id", "slider-buttons-left", 3, "click"], ["id", "slider-buttons-right", 3, "click"], ["alt", "", 3, "src"]], template: function SliderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("click", function SliderComponent_Template_a_click_6_listener($event) { return ctx.moveLeft(); });
        ɵngcc0.ɵɵtext(7, "\u276E");
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(8, "a", 6);
        ɵngcc0.ɵɵlistener("click", function SliderComponent_Template_a_click_8_listener($event) { return ctx.moveRight(); });
        ɵngcc0.ɵɵtext(9, "\u276F");
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
